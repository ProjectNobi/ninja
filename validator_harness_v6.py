...
JUDGE_PROMPT_OPUS = (
    ...
    "Empty patch, patch that cannot apply, syntactically invalid code, "
    "or patch that makes the bug worse.\n\n"
    'Respond with ONLY valid JSON (no markdown fences):\n'
    '{{"score_a": 0-100, "score_b": 0-100, '
    '"reasoning": "one sentence explaining the key difference"}}'
)

DATASET_PATH    = "/root/sn66-r2-dataset/hf_dataset_cache.jsonl"  # hf_dataset used
...
def llm_judge(
    ...
    if "opus" in model.lower() or "claude" in model.lower():
        ...
        prompt = (
            ...
            '{"score_a": 0-100, "score_b": 0-100, "reasoning": "one sentence"}'
        )
        max_tokens = 150
    ...
    for attempt in range(max_retries):
        try:
            ...
            return {"score_challenger": 0.5, "score_king": 0.5,
                    "reasoning": f"parse_failed:{content_str[:60]}"}
