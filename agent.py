...
**FEATURE and UPDATE tasks:** Before writing any code, enumerate ALL deliverables from the issue description as a checklist. Verify every item is addressed before finalizing. A patch missing one required component scores zero for that requirement.
