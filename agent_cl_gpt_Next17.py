#!/usr/bin/env python3
"""SN66 Next17 challenger -- a flat, single-file re-base on the current king
...
def render_observation(*, returncode: int, output_text: str, remaining_steps: int) -> str:
    ...
    if remaining_steps <= 3:
        ...
        remaining_note = (
            f"[{remaining_steps} steps left. Stop exploring -- apply your fix now, "
            f"wire every new symbol into its call sites, then submit with "
