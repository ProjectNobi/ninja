#!/usr/bin/env python3
"""SN66 Ninja miner — Next2-v3.

Built on new king (01c675065c1c): preserves verify-repair pass, multi-file
inline, native tool-call regex.

Additions over king:
- Task-type detection: injects UPDATE/BUGFIX/FEATURE/OTHER protocol into first turn.
- SYSTEM_PROMPT: completeness-first, acceptance-criteria, BUGFIX minimal-change rule.
"""
...
while a slightly-too-broad edit is only mildly penalized.

## ACCEPTANCE CRITERIA FIRST
Before writing ANY code, identify every acceptance criterion. Address ALL of them.
...
def _detect_task_type(task_text: str) -> str:
    ...
    # Priority: a clear bug signal wins; then UPDATE (wiring discipline); then
    # FEATURE; else OTHER. Ties resolve toward the most corrective protocol.
